  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-background">
        <div
          className={cn(
            "mx-auto flex max-w-[1400px] items-center px-6 py-7 md:px-10 md:py-8",
            isHome ? "justify-end md:justify-center" : "justify-between"
          )}
        >
          {isHome ? null : (
            <Link
              href="/"
              className="font-sans text-[0.95rem] font-semibold leading-none tracking-[0.22em] uppercase text-foreground md:text-[1.05rem]"
            >
              {site.name}
            </Link>
          )}
